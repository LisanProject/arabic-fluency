...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\textbf{Quote}}, toptitle=1mm, rightrule=.15mm, titlerule=0mm, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, coltitle=black, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm]
